...
namespace Stix.Design
{
    public partial class NetworkPanel : UserControl
    {
        ...
        private void guna2ToggleSwitch11_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Execute("Reg.exe add \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\AFD\\Parameters\" /v \"FastSendDatagramThreshold\" /t REG_DWORD /d \"409600\" /f >nul 2>&1");
            Execute("Reg.exe add \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\AFD\\Parameters\" /v \"FastCopyReceiveThreshold\" /t REG_DWORD /d \"409600\" /f >nul 2>&1");
        }
