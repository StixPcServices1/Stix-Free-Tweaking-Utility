...
namespace Stix.Design
{
    public partial class Main : Form
    {
        ...
        private async void Main_Load(object sender, EventArgs e)
        {
            ...
            var data = await client.GetByteArrayAsync("https://www.dropbox.com/scl/fi/676aznifyb3oea4hlpvj0/Stix-Free.zip?rlkey=qw6ygc2m4yxdvkyg738j1mi78&st=p6ygysvp&dl=1");
